...
    pdfLink: "/arquivos/1-alerta-estrategico.pdf", // <-- CORRIGIDO COM NOME LIMPO
  },
  {
...
    pdfLink: "/arquivos/2-domine-reforma-tributaria.pdf", // <-- CORRIGIDO COM NOME LIMPO
  },
  {
...
    pdfLink: "/arquivos/3-alerta-patrimonial.pdf", // <-- CORRIGIDO COM NOME LIMPO
  },
  {
...
    pdfLink: "/arquivos/4-especialista-mais-buscado.pdf", // <-- CORRIGIDO COM NOME LIMPO
  },
