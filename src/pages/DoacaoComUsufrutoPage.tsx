            ...
            <table className="min-w-full bg-white border border-gray-200">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="py-3 px-6 text-left text-sm font-semibold text-gray-800">Doador (Usufrutuário)</th>
                  <th className="py-3 px-6 text-left text-sm font-semibold text-gray-800">Donatário (Nu-proprietário)</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="py-4 px-6 text-gray-600 text-sm">Mantém o direito de uso e rendimentos do bem durante o período estabelecido.</td>
                  <td className="py-4 px-6 text-gray-600 text-sm">Recebe a propriedade, mas a posse plena ocorre após a extinção do usufruto.</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-600 text-sm">Responsável pela conservação e encargos ordinários do bem.</td>
                  <td className="py-4 px-6 text-gray-600 text-sm">Possui a nua-propriedade, com restrições de alienação conforme o contrato.</td>
                </tr>
              </tbody>
            </table>
          </div>
