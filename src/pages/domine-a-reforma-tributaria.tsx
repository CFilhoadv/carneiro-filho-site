...
// === COMPONENTE MainLayout (MANTIDO CONFORME ORIGINAL) ===
    ...
    <header className="bg-blue-950 text-white p-4 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav>
          ...
          <a href="/cursos" className="mx-2 hover:text-blue-400 transition duration-300">Cursos</a>
        </nav>
      </div>
    </header>
    <main>
...
// === COMPONENTE DA PÁGINA (EXPORTAÇÃO PADRONIZADA PARA O App.tsx) ===
const DomineAReformaTributariaPage: React.FC = () => {
    ...
    <MainLayout>
      <div className="container mx-auto px-4 font-inter">
        ...
        <section className="py-12 px-4 text-center bg-white text-gray-900">
          ...
          <ul className="list-disc list-inside space-y-2 text-xl leading-relaxed text-gray-700 text-left max-w-4xl mx-auto">
        ...
        <section className="py-12 px-4 text-center bg-gray-100 text-gray-900">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 text-xl leading-relaxed">
            <div className="p-6 border border-gray-300 rounded-lg shadow-lg bg-white text-gray-700">
              ...
              <p className="mt-2 text-sm text-justify">Entenda a complexidade e injustiças do sistema tributário atual que tornam a reforma inevitável.</p>
            </div>
            <div className="p-6 border border-gray-300 rounded-lg shadow-lg bg-white text-gray-700">
              <h3 className="text-2xl font-semibold text-blue-950">Módulo 2: Análise Estratégica - A Inversão do Poder Fiscal</h3>
              <p className="mt-2 text-sm text-justify">Descubra o jogo de poder por trás da reforma e como o novo Comitê Gestor do IBS centraliza as decisões.</p>
            </div>
            <div className="p-6 border border-gray-300 rounded-lg shadow-lg bg-white text-gray-700">
              <h3 className="text-2xl font-semibold text-blue-950">Módulo 3: A Regulamentação em Andamento</h3>
              <p className="mt-2 text-sm text-justify">Analise o PLP 108/2024 e as mudanças práticas no ITCMD, impostos seletivos e fiscalização de aluguéis.</p>
            </div>
            <div className="p-6 border border-gray-300 rounded-lg shadow-lg bg-white text-gray-700">
              <h3 className="text-2xl font-semibold text-blue-950">Módulo 4: Preparação e Transição</h3>
              <p className="mt-2 text-sm text-justify">Guia estratégico para adaptação de empresas e famílias ao novo sistema, com cronograma de implantação.</p>
            </div>
            <div className="p-6 border border-gray-300 rounded-lg shadow-lg bg-white text-gray-700">
              <h3 className="text-2xl font-semibold text-blue-950">Módulo 5: Impactos Setoriais e Oportunidades</h3>
              <p className="mt-2 text-sm text-justify">Estratégias específicas para varejo, serviços, indústria, agronegócio e planejamento patrimonial.</p>
            </div>
          </div>
        </section>
        ...
        <section id="inscricao-final" className="py-12 px-4 text-center bg-white text-gray-900 shadow-2xl">
          ...
          <div className="max-w-md mx-auto p-6 border-4 border-green-500 rounded-xl bg-green-50 shadow-2xl">
            ...
            <p className="mt-2 text-2xl font-medium text-red-600 uppercase">
          ...
          <div className="max-w-xl mx-auto mt-8 p-4 border border-gray-300 rounded-lg text-left bg-white">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 text-lg">
              <li className="font-semibold">GARANTIA INCONDICIONAL DE 7 DIAS.</li>
              <li>ACESSO VITALÍCIO às atualizações.</li>
              <li>SUPORTE DIRETO com a equipe técnica.</li>
            </ul>
          </div>
        </section>
      </div>
...
export default DomineAReformaTributariaPage;