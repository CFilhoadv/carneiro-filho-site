...
const ServicosStaging: React.FC = () => {
  return (
    <MainLayout>
      <section className="bg-gray-50 pt-10 pb-12 border-b border-gray-200 text-center">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          {/* Texto Introdutório */}
          <div className="space-y-6 text-gray-700 leading-relaxed text-lg text-justify mb-20 border-b border-gray-100 pb-12">
            <p>
          ...
          <div className="space-y-20">
            ...
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito Civil e Contencioso Patrimonial</h2>
              ...
              <Link to="/analise-preliminar" className="inline-block bg-blue-900 text-white px-8 py-4 rounded-sm font-bold tracking-widest text-xs hover:bg-blue-800 transition-all shadow-md">
            ...
            {/* Direito de Família */}
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito de Família</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
            ...
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito das Sucessões</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
            ...
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Planejamento Patrimonial e Sucessório</h2>
              ...
              <div className="mb-8">
                <Link to="/planejamento-sucessorio" className="text-blue-900 font-bold uppercase tracking-widest text-sm border-b-2 border-blue-900 pb-1 hover:text-blue-700 transition-colors">
            ...
            {/* Direito Empresarial */}
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito Empresarial</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
            ...
            {/* Direito Tributário */}
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito Tributário</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
            ...
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito Previdenciário</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
            ...
            <div className="p-8 bg-gray-50 border border-gray-100">
              <h2 className="text-2xl font-bold text-blue-900 uppercase tracking-wide mb-4">Direito do Trabalho (contencioso)</h2>
              <p className="text-gray-700 leading-relaxed mb-8">
