    ...
    <MainLayout>
      ...
      <section className="py-10 md:py-16 bg-white text-gray-800">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="text-gray-700 leading-relaxed text-base md:text-lg mb-10 md:mb-16 border-b border-gray-100 pb-8 md:pb-10 text-justify md:text-left">
            <p className="max-w-4xl">
              Oferecemos soluções jurídicas claras e sem burocracia. Unimos o rigor técnico da nossa trajetória corporativa à sensibilidade humana desenvolvida na Defensoria Pública para proteger seus direitos e seu patrimônio.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-20">
            ...
            <div className="group p-5 md:p-6 bg-blue-50 rounded-sm border-l-4 border-blue-900 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center mb-3 md:mb-4">
                ...
                <h2 className="text-lg md:text-xl font-bold text-blue-900 uppercase tracking-tight">Direito Tributário</h2>
              </div>
              <p className="text-gray-700 leading-relaxed text-sm md:text-base text-justify">
                Atuação em <strong>recuperação de créditos fiscais</strong> para gerar fôlego financeiro às empresas e análise técnica de impostos para garantir economia e segurança em inventários e negócios imobiliários.
              </p>
            </div>

            <div className="group p-5 md:p-6 bg-gray-50 rounded-sm border-l-4 border-blue-900 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center mb-3 md:mb-4">
            ...
            <div className="group p-5 md:p-6 bg-blue-900 rounded-sm shadow-md transition-all">
              ...
              <p className="text-blue-100 leading-relaxed text-sm md:text-base mb-4 text-justify">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-blue-900 p-6 md:p-8 rounded-sm text-white shadow-xl flex flex-col justify-between border-t-4 border-blue-400">
              <div>
                <h3 className="font-bold uppercase tracking-widest text-[10px] mb-3 text-blue-200">Sorocaba • Presencial</h3>
                <p className="text-blue-100 text-xs mb-4">Canais oficiais para suporte técnico e agendamentos.</p>
              </div>
              <div className="space-y-3">
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-green-600 text-white py-3 rounded-sm font-bold uppercase tracking-widest text-[10px] hover:bg-green-700 transition-all shadow-md">
                  <MessageCircle size={16} className="mr-2" /> Atendimento Digital
                </a>
                <a href={telSorocaba} className="flex items-center justify-center bg-blue-800 text-white py-3 rounded-sm font-bold uppercase tracking-widest text-[10px] hover:bg-blue-700 transition-all shadow-md border border-blue-400">
            ...
            <div className="bg-gray-50 p-6 md:p-8 rounded-sm flex flex-col justify-between border border-gray-200 shadow-sm">
              <div>
                <h3 className="font-bold text-blue-900 uppercase tracking-widest text-[10px] mb-3">São Paulo • Administrativo</h3>
                <p className="text-gray-600 text-xs mb-4 italic">Suporte estratégico para a capital.</p>
              </div>
              <div className="space-y-3">
                <a href={telSP} className="flex items-center justify-center bg-white text-blue-900 py-3 rounded-sm font-bold uppercase tracking-widest text-[10px] border-2 border-blue-900 hover:bg-gray-100 transition-all shadow-sm">
