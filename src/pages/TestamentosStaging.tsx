    ...
    <MainLayout>
      <section className="bg-gray-50 pt-6 pb-8 border-b border-gray-200">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 uppercase text-center">Testamentos</h1>
      ...
      <section className="py-12 bg-white text-justify">
        <div className="container mx-auto px-4 max-w-4xl leading-relaxed text-lg space-y-8 text-justify">
          <p>O testamento é o ato jurídico solene e revogável pelo qual uma pessoa dispõe de seu patrimônio para depois de sua morte.</p>
