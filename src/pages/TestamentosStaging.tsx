              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-6 md:p-8 rounded-sm border border-gray-200 flex flex-col justify-between shadow-sm">
                  <div>
                    ...
                    <p className="text-gray-600 text-[10px] md:text-xs leading-relaxed mb-6 italic text-left">Suporte administrativo e gestão documental estratégica para o planejamento.</p>
                  </div>
                  <div className="space-y-3">
