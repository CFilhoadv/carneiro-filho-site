...
const TestamentosStaging: React.FC = () => {
  ...
  return (
    <MainLayout>
      {/* Cabeçalho Padronizado - Ajustado para py-8 no mobile para reduzir o vazio */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-6 md:p-8 rounded-sm border border-gray-200 flex flex-col justify-between opacity-80">
                  <div>
                    ...
                    <p className="text-gray-500 text-[10px] md:text-xs leading-relaxed mb-6">Suporte administrativo e gestão documental estratégica.</p>
                  </div>
                  <div className="space-y-3">
