...
// Importação das imagens das unidades
...
const HomeStaging: React.FC = () => {
  ...
  return (
    <MainLayout>
      {/* 1. BOTÃO FLUTUANTE WHATSAPP - Único elemento de destaque constante */}
      <a 
        href={whatsappLink} 
        target="_blank" 
      ...
      {/* 2. BANNER PRINCIPAL (HERO) - RESTAURADO E LIMPO */}
      <section className="relative h-[400px] md:h-[550px] flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white text-lg md:text-2xl font-medium leading-relaxed drop-shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                Envie sua dúvida via <strong>WhatsApp</strong>. Atendimento sem "juridiquês" desde o início.
              </p>
            </div>
      ...
      {/* 5. SEÇÃO NOSSAS UNIDADES - Links clicáveis discretos */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-6 md:p-8 shadow-md rounded-sm border-t-4 border-blue-900">
              ...
              <h4 className="text-xl font-bold text-blue-900 mb-2">Sorocaba</h4>
              <p className="text-gray-600 text-sm mb-4">Edifício Av. Paulista, Campolim.</p>
              <div className="space-y-2">
                ...
                <a href="tel:1531911432" className="flex items-center text-lg font-bold text-blue-900 hover:underline">
            ...
            <div className="bg-white p-6 md:p-8 shadow-md rounded-sm border-t-4 border-gray-400 opacity-90">
              ...
              <h4 className="text-xl font-bold text-gray-800 mb-2">São Paulo</h4>
              <div className="space-y-2">
                ...
                <a href="tel:1142106194" className="flex items-center text-lg font-bold text-gray-500 hover:underline">
      ...
      {/* 6. CTA FINAL - INSTITUCIONAL E LIMPO */}
