      ...
      <section className="py-10 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 mb-12 md:mb-20 items-center">
            <div className="lg:col-span-7 space-y-4 md:space-y-6 text-gray-700 leading-relaxed text-base md:text-lg">
              <p className="text-justify">
                O planejamento sucessório é sobre <strong>preservar a harmonia da sua família</strong>. Organizamos a transmissão do patrimônio antecipadamente, evitando inventários lentos e desgastantes.
              </p>
              <p className="text-justify">
          ...
          <div className="mb-16 md:mb-24">
            <h2 className="text-xl md:text-2xl font-bold text-blue-900 uppercase tracking-wide mb-8 text-center md:text-left">Soluções de Planejamento</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10 md:pt-12 border-t border-gray-100">
            ...
            <div className="bg-blue-900 p-8 rounded-sm text-white shadow-xl flex flex-col justify-between border-t-4 border-blue-400">
              <div>
                ...
                <p className="text-blue-100 text-sm mb-8 leading-relaxed italic">Inicie seu planejamento com uma análise preliminar feita diretamente pelo Dr. Francisco.</p>
              </div>
