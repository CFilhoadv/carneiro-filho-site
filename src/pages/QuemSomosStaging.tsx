          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <article>
                ...
                <p className="text-lg leading-relaxed text-gray-700 text-justify italic border-l-4 border-blue-900 pl-6 bg-gray-50 py-4">
            ...
            {/* Coluna da Direita: Card de Autoridade (Sticky) */}
            <div className="lg:col-span-4">
              <div className="sticky top-32">
                <div className="bg-blue-900 text-white p-8 rounded-sm shadow-xl border-b-8 border-blue-700 text-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">Advogado Titular</h3>
                  <p className="text-2xl font-bold mb-4">Francisco de Assis Carneiro Filho</p>
                  <p className="text-blue-200 font-bold tracking-widest uppercase text-xs mb-4">
                    Bacharel em Direito e Contabilista<br/>
                    MBA Executivo - FGV
                  </p>
                  <p className="text-white font-bold tracking-widest uppercase text-sm border-t border-blue-800 pt-4">
                    OAB/SP nº 189.404
                  </p>
                </div>
              </div>
