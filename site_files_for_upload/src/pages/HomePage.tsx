  ...
  const banners = [
    {
      ...
      subtitle: "SOLUÇÕES JURÍDICAS PARA PESSOAS E EMPRESAS",
      description: "Direito Empresarial, Direito Civil, Direito Tributário, Direito Previdenciário, Direito Trabalhista e Direito do Consumidor",
    ...
    },
    {
      ...
      subtitle: "PLANEJAMENTO TRIBUTÁRIO SUCESSÓRIO E PATRIMONIAL",
      description: "Evite burocracia e maximize seu legado. Com o Planejamento Sucessório, você organiza a transmissão de bens e direitos de forma eficiente, evitando conflitos familiares e otimizando tributos. Conheça nossas soluções completas em holdings familiares, doações, testamentos e inventários e tome as rédeas do seu futuro.",
    ...
    <MainLayout>
      ...
      <div className="relative">
        <Banner 
          ...
          bgColor="bg-blue-900"
          height="h-[600px]" // Definindo a altura do banner carrossel para 600px
        />
